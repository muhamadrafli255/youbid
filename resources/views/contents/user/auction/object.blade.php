...
<div class="container d-flex flex-column mt-5">
    <div class="row flex-grow-1">
        ...
        <div class="col-9 mt-2">
            <div class="row">
                <h6>Menampilkan {{ $lots->count() }} lelang dari semua kategori barang yang ada</h6>
                <hr>
                @foreach ($lots as $lot)
                    <div class="col-3 mb-3">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <p class="font-weight-bold" style="margin-top: -13px; margin-bottom: 1px;">{{ 'Rp. '.strrev(implode('.',str_split(strrev(strval($lot->initial_price)),3))) }}</p>
                                <span class="d-flex">
