...
<div class="container-fluid">
    ...
    <p class="mb-4">Berikut adalah formulir untuk mendaftarkan kategori ke dalam aplikasi <a href="/" class="text-primary">YouBID</a>.</p>

    <div class="card shadow mb-4">
        <div class="card-header">
            <h6 class="text-primary font-weight-bold">Form Tambah Kategori</h6>
        </div>
        <div class="card-body">
            <form action="/categories/create" method="POST" class="form-group" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12 mx-auto mb-3">
                        <label class="font-weight-bold text-primary" for="">Nama Kategori</label>
                    ...
                    <label class="font-weight-bold text-primary mx-auto mt-3 mb-2" for="">Foto Kategori</label>
                    ...
                    <div class="col-12 text-right">
                        <a href="/categories" class="btn btn-secondary text-light">Kembali</a>
