...
<head>
    ...
    <title>Youbid - Atur Ulang Password</title>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%%">
                                <tr>
                                    <td
                                        ...
                                        Atur Ulang Password Akun Youbid Anda
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%%">
                                ...
                                <tr>
                                    <td style="padding: 0; font-family: Nunito, sans-serif; font-size: 16px;">
                                        Apakah anda melupakan kata sandi?, Silahkan klik tombol dibawah untuk mengatur kata sandi baru
                                    </td>
                                </tr>
                                <tr>
                                    <td
                                        style="padding: 20px 0 20px 0; font-family: Nunito, sans-serif; font-size: 16px; text-align: center;">
                                        <a href="{{ env('APP_URL') }}/create-password/{{ $token }}"
                                ...
                                <tr>
                                    <td style="padding: 0; font-family: Nunito, sans-serif; font-size: 16px;">
                                        Jika Anda kesulitan mengklik tombol "Atur Password", copy dan paste URL di
                                        bawah ke dalam browser Anda:
                                        <p id="url">{{ env('APP_URL') }}/confirm-password/{{ $token }}</p>
                                    </td>
                                </tr>
                                <tr>
