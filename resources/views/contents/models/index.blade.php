...
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4">Berikut adalah data model yang ada di <a href="/" class="text-danger">YouBID</a>.</p>
                            ...
                            <div class="card shadow mb-4 dt-container">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/models/create" class="btn btn-sm btn-outline-danger rounded mb-2"><i
