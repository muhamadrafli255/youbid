...
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4">Berikut adalah detail merk dari merk <span class="text-primary">{{ $brand->name }}</span>.</p>
                            ...
                            <div class="card shadow mb-4 dt-container">
                                <div class="card-header py-3">
                                    ...
                                    <p class="m-0">Berikut adalah data model yang ada pada merk <span class="text-primary">{{ $brand->name }}</span>.</p>
                                </div>
                                <div class="card-body">
