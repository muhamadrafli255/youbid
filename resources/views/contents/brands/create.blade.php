...
<div class="container-fluid">
    ...
    <p class="mb-4">Berikut adalah formulir untuk mendaftarkan merk ke dalam aplikasi <a href="/" class="text-primary">YouBID</a>.</p>

    <div class="card show mb-4">
        <div class="card-header">
            <h6 class="text-primary font-weight-bold">Form Tambah Merk</h6>
        </div>
        <div class="card-body">
