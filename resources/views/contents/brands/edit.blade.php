...
<div class="container-fluid">
    ...
    <p class="mb-4">Berikut adalah formulir untuk mengubah merk pada aplikasi <a href="/" class="text-danger">YouBID</a>.</p>

    <div class="card show mb-4">
        <div class="card-header">
            <h6 class="text-danger font-weight-bold">Form Ubah Merk</h6>
        </div>
        <div class="card-body">
