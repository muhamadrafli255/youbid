...
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4">Berikut adalah halaman untuk merubah data barang pada aplikasi <a href="/" class="text-danger">YouBID</a>.</p>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header">
                                    <h6 class="text-danger font-weight-bold">Form Ubah Barang</h6>
                                </div>
                                                        ...
                                                        <form id="msform" action="/items/{{ $item->id }}/edit" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <fieldset>
                                                                <div class="user row">
                                                                    ...
                                                                    <div class="col-12 text-left from-group mb-3">
                                                                        <label class="font-weight-bold text-danger" for="name">Nama Barang</label>
                                                                    ...
                                                                    <div class="col-12 text-left from-group mb-3">
                                                                        <label class="font-weight-bold text-danger" for="item_model_id">Nama Model</label>
                                                                    ...
                                                                    <div class="col-12 text-left form-group mb-3">
                                                                        <label class="font-weight-bold text-danger" for="description">Deskripsi</label>
                                                            ...
                                                            <fieldset>
                                                                <div class="user row mb-4">
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="policeNumber">Nomor Polisi</label>
                                                                ...
                                                                @enderror
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="machineCapacity">Kapasitas Mesin</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="transmission">Transmisi</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="chassisNumber">Nomor Rangka</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="machineNumber">Nomor Mesin</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="kilometers">Kilometer</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="fuel">Bahan Bakar</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="physicalColor">Warna Fisik</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="vehicleRegistration">STNK</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="vehicleRegistrationDate">Tanggal STNK</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="bookVehicleOwner">BPKB</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="receipt">Kuitansi</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="ownerIdentity">KTP Pemilik</label>
                                                            ...
                                                            <fieldset>
                                                                <div class="user row">
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="interior">Interior</label>
                                                                    ...
                                                                    <div class="col-sm-6 from-group mb-3 text-left">
                                                                        <label class="font-weight-bold text-danger" for="exterior">Eksterior</label>
