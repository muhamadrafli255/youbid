@extends('app.main')
    ...
    @section('script')
        ...
        <script src="/app/item/index.js"></script>
    @endsection
...
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4">Berikut adalah data barang yang ada di <a href="/" class="text-danger">YouBID</a>.</p>
                            ...
                            <div class="card shadow mb-4 dt-container">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-danger">Tabel Barang</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <a href="/items/create" class="btn btn-sm btn-outline-danger rounded mb-2"><i
                                    ...
                                    <div class="table-responsive">
                                        <table id="dtItems" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama Barang</th>
