...
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4">Berikut adalah data lot yang ada di <a href="/" class="text-primary">YouBID</a>.</p>
                            ...
                            <div class="card shadow mb-4 dt-container">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tabel Lot</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <a href="/lots/create" class="btn btn-sm btn-outline-primary rounded mb-2"><i
