@extends('app.main')
    ...
    @section('script')
        ...
        <script src="/app/location/index.js"></script>
    @endsection
...
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4">Berikut adalah data lokasi yang ada di <a href="/" class="text-primary">YouBID</a>.</p>
                            ...
                            <div class="card shadow mb-4 dt-container">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/location/create" class="btn btn-sm btn-outline-primary rounded mb-2"><i
                                    ...
                                    <div class="table-responsive">
                                        <table id="dtLocation" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama Lokasi</th>
