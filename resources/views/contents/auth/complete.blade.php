                                    ...
                                    <div class="col-12">
                                        <div class="p-5">
                                            <div class="text-center mt-4">
                                                ...
                                                <p class="mb-4">Silahkan untuk melengkapi data agar dapat mengakses semua fitur <span class="text-primary">Youbid</span></p>
                                            </div>
                                            <div class="row">
                                                        ...
                                                        <fieldset>
                                                            <div class="user row">
                                                                ...
                                                                <div class="col-sm-6 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">NIK</label>
                                                                ...
                                                                <div class="col-sm-6 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">No Telepon</label>
                                                                ...
                                                                <div class="col-12 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for=",gender">Jenis Kelamin</label>
                                                                ...
                                                                <div class="col-sm-6 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">Provinsi</label>
                                                                ...
                                                                <div class="col-sm-6 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">Kabupaten / Kota</label>
                                                                    <select name="city" id="cities" class="form-control" required>
                                                                        <option>Pilih Kabupaten / Kota...</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-6 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">Kecamatan</label>
                                                                    <select name="district" id="districts" class="form-control" required>
                                                                        <option>Pilih Kecamatan...</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-6 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">Desa</label>
                                                                ...
                                                                <div class="col-12 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">Kode Pos</label>
                                                                ...
                                                                <div class="col-12 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="full_address">Alamat Lengkap</label>
                                                            ...
                                                            <input type="button" name="next" class="next btn btn-primary mt-4 text-light text-decoration-none" value="Selanjutnya"/>
                                                        </fieldset>
                                                        <fieldset>
                                                            ...
                                                            <hr>
                                                            <input type="button" name="previous" class="previous btn btn-secondary text-decoration-none mt-4" value="Kembali"/>
                                                            <input type="button" name="next" class="next btn btn-primary mt-4 text-light" value="Selanjutnya"/>
                                                        </fieldset>
                                                        <fieldset>
                                                            <div class="user row">
                                                                <h2 class="col-12 fs-title">Rekening Bank</h2>
                                                                <div class="col-sm-6 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">Pemilik Rekening</label>
                                                                ...
                                                                <div class="col-sm-6 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="">Nomor Rekening</label>
                                                                ...
                                                                <div class="col-12 form-group mb-3">
                                                                    <label class="font-weight-bold text-primary float-left" for="bank">Nama Bank</label>
                                                            ...
                                                            <button type="submit" class="btn btn-primary text-decoration-none text-light">Kirim</button>
                                                        </fieldset>
                                                        @endforeach
                                                    </form>
                                                </div>
