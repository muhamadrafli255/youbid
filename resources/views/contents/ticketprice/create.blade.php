...
<div class="container-fluid">
    ...
    <p class="mb-4">Berikut adalah formulir untuk mendaftarkan harga tiket ke dalam aplikasi <a href="/" class="text-primary">YouBID</a>.</p>

    <div class="card shadow mb-4">
        <div class="card-header">
            <h6 class="text-primary font-weight-bold">Form Tambah Harga Tiket</h6>
        </div>
        <div class="card-body">
            <form action="/ticketprice/create" method="POST" class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-right">
                        <a href="/ticketprice" class="btn btn-secondary text-light">Kembali</a>
