...
<div class="container-fluid">
    ...
    <p class="mb-4">Berikut adalah formulir untuk mengubah harga tiket pada aplikasi <a href="/" class="text-primary">YouBID</a>.</p>

    <div class="card shadow mb-4">
        @foreach ($ticketPrices as $price)
        <div class="card-header">
            <h6 class="text-primary font-weight-bold">Form Ubah Harga Tiket</h6>
        </div>
        <div class="card-body">
