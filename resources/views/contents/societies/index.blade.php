@extends('app.main')
    ...
    @section('script')
        ...
        <script src="/app/societies/index.js"></script>
    @endsection
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4 dt-container">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/societies/create" class="btn btn-sm btn-outline-primary rounded mb-2"><i
                                ...
                                <div class="table-responsive">
                                    <table id="dtSociety" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Foto Profile</th>
