...
@section('content')
    <div class="container-fluid">
                                ...
                                <p class="mb-4">Berikut adalah formulir untuk merubah data masyarakat di <a href="/" class="text-primary">YouBID</a>.</p>

                                @foreach ($societies as $society)
                                <div class="card show mb-4">
                                    <div class="card-header">
                                        <h6 class="text-primary font-weight-bold">Form Edit Masyarakat</h6>
                                    </div>
                                    <div class="card-body">
