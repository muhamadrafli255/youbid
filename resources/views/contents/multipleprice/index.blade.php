@extends('app.main')
    ...
    @section('script')
        ...
        <script src="/app/multipleprice/index.js"></script>
    @endsection
...
@section('content')
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4">Berikut adalah data harga yang ada di <a href="/" class="text-primary">YouBID</a>.</p>
                            ...
                            <div class="card shadow mb-4 dt-container">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tabel Harga Kelipatan</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <a href="/multipleprice/create" class="btn btn-sm btn-outline-primary rounded mb-2"><i
                                    ...
                                    <div class="table-responsive">
                                        <table id="dtMultiplePrice" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama Kategori</th>
