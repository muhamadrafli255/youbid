...
<div class="container-fluid">
    ...
    <p class="mb-4">Berikut adalah formulir untuk mengubah harga kelipatan pada aplikasi <a href="/" class="text-danger">YouBID</a>.</p>

    <div class="card shadow mb-4">
        @foreach ($multiplePrices as $price)
        <div class="card-header">
            <h6 class="text-danger font-weight-bold">Form Ubah Harga Kelipatan</h6>
        </div>
        <div class="card-body">
