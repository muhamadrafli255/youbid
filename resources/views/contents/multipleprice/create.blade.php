...
<div class="container-fluid">
    ...
    <p class="mb-4">Berikut adalah formulir untuk mendaftarkan harga kelipatan ke dalam aplikasi <a href="/" class="text-danger">YouBID</a>.</p>

    <div class="card shadow mb-4">
        <div class="card-header">
            <h6 class="text-danger font-weight-bold">Form Tambah Harga Kelipatan</h6>
        </div>
        <div class="card-body">
